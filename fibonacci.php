...
<body>
    ...
    <!-- ISI -->
    <section id="Fibonacci" style="background-color: honeydew ;">
        <div class="container">
                ...
                <div class="col ">
                    <form method="POST" action="#" class="bg-honeydew form-container" id="forminput">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo $jmlderet; ?>" id="jmlderet" placeholder="Masukkan Total Jumlah Deret" name="jmlderet" required />
                        </div>
                        <br>
